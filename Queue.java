...
class queue_operation{
	...
	void display(){
		System.out.println("The queue elements are given below,");
		node v=temp;
		while(v!=null){
	...
	void Size(){
		...
		System.out.println("The number of elements im a queue is "+count);
	}
	void isEmpty(){
		if (temp.data==null){
...
class queue{
	public static void main(String args[]){
		...
		queue_operation obj1=new queue_operation();
		String text="""
